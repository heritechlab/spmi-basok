...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Laporan Audit Mutu Internal (AMI) Institusi</h4>
    ...
    <div class="dual-card-row mb-3">
        ...
        <div class="greeting-card">
            ...
            <div class="indicator-summary-greeting">
                Susun Laporan Audit Mutu Internal resmi tingkat Institusi, siap cetak.
            </div>
        ...
        <div class="info-card info-card-compact">
            ...
            <div class="info-card-body">
                ...
                <div class="info-card-total">
                    <div class="info-card-total-label">Periode Tersedia</div>
                    <div class="info-card-total-value"><?= count($periods) ?></div>
                </div>
                ...
                <div class="info-card-items-grid info-card-items-grid-1">
                    ...
                    <div class="info-card-item accent-purple">
                        ...
                        <div class="info-card-text">
                            <div class="info-card-label">Cakupan</div>
                            <div class="info-card-value" style="font-size:14px;">Semua Unit</div>
                        </div>
                    </div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <p class="text-muted">
                Pilih Periode Audit untuk menyusun Laporan AMI Institusi (gabungan seluruh Unit Kerja) —
                Cover, Halaman Pengesahan, Kata Pengantar, BAB I s.d. BAB V.
            </p>

            <form id="reportForm" target="_blank" action="<?= BASE_URL ?>laporan/ami_institusi/print.php" method="get">
            ...
            <button type="button" class="btn btn-outline-primary btn-sm mt-2" id="btnManageSignature">
                <i class="bi bi-pen"></i> Kelola TTD untuk Periode di atas
            </button>
...
document.getElementById('btnManageSignature').addEventListener('click', function () {
    ...
    window.location.href = '<?= BASE_URL ?>laporan/signatures/manage.php?type=institusi&period_id=' + periodId;
});
</script>
