...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Laporan Rencana Tindak Lanjut (RTL) per Unit Kerja</h4>
    ...
    <div class="dual-card-row mb-3">
        ...
        <div class="greeting-card">
            ...
            <div class="indicator-summary-greeting">
                Tampilkan daftar bukti pelaksanaan RTL yang telah diunggah Auditee untuk Unit Kerja tertentu.
            </div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <p class="text-muted">
                Pilih Unit Kerja dan Periode Audit untuk menampilkan daftar bukti pelaksanaan RTL yang
                telah diunggah oleh Auditee.
            </p>

            <form id="reportForm" target="_blank" action="<?= BASE_URL ?>laporan/rtl/print.php" method="get">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3 d-flex align-items-end">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bi bi-file-earmark-text"></i> Tampilkan
                        </button>
                    </div>
