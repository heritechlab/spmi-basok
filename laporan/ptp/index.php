...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Laporan Rapat Tinjauan Manajemen (RTM) Peningkatan</h4>
    ...
    <div class="dual-card-row mb-3">
        ...
        <div class="greeting-card">
            ...
            <div class="indicator-summary-greeting">
                Susun Laporan Permintaan Tindakan Peningkatan resmi untuk Unit Kerja tertentu, siap cetak.
            </div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <p class="text-muted">
                Pilih Unit Kerja dan Periode Audit untuk menyusun Laporan PTP (Cover, Halaman Pengesahan,
                Berita Acara Rapat, dan daftar Peningkatan yang diusulkan/diterapkan).
            </p>

<form id="reportForm" target="_blank" action="<?= BASE_URL ?>laporan/ptp/print.php" method="get">

                <input type="hidden" name="type" value="ptp">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3 d-flex align-items-end">
                        <button type="submit" formaction="<?= BASE_URL ?>laporan/signatures/manage.php" formtarget="_self" class="btn btn-outline-secondary w-100">
                            <i class="bi bi-pen"></i> Kelola TTD
                        </button>
                    </div>
