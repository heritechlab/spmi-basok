...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Laporan Rapat Tinjauan Manajemen (RTM) Pengendalian</h4>
    ...
    <div class="dual-card-row mb-3">
        ...
        <div class="greeting-card">
            ...
            <div class="indicator-summary-greeting">
                Susun Laporan Rapat Tinjauan Manajemen resmi untuk Unit Kerja tertentu, siap cetak.
            </div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <p class="text-muted">
                Pilih Unit Kerja dan Periode Audit untuk menyusun Laporan RTM (Cover, Halaman Pengesahan,
                daftar Rapat, Notulen, Bukti Kegiatan, dan RTL yang dihasilkan).
            </p>

            <form id="reportForm" target="_blank" action="<?= BASE_URL ?>laporan/rtm/print.php" method="get">
