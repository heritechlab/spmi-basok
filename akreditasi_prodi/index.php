...
<div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Data Dukung Akreditasi Program Studi</h4>
        <div class="d-flex gap-2">
            <a href="<?= BASE_URL ?>akreditasi_prodi/public.php" target="_blank" class="btn btn-outline-success btn-sm">
    ...
    <div class="dual-card-row mb-3">
        ...
        <div class="greeting-card">
            ...
            <div class="indicator-summary-greeting">
                Kelola dokumen bukti dukung akreditasi Program Studi berdasarkan 8 Kriteria penilaian.
            </div>
        ...
        <div class="info-card info-card-compact">
            ...
            <div class="info-card-body">
                ...
                <div class="info-card-total">
                    <div class="info-card-total-label">Total Dokumen Prodi</div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover" id="tableAkreditasiProdi">
                <thead>
                    <tr>
        ...
        <div class="modal-content">
            ...
            <form id="uploadForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Upload Dokumen Akreditasi Prodi</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="document_name" name="document_name" placeholder="Contoh: Dokumen Kurikulum Program Studi" required>
                    </div>
...
<script src="<?= BASE_URL ?>assets/js/akreditasi_prodi.js"></script>